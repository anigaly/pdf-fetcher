...
- If you have issues with python version like:
    ...
    ```bash
    The currently activated Python version 3.9.7 is not supported by the project (~3.13.0)
    ...
    NoCompatiblePythonVersionFound
    ...
    ```

    Check version of your `python3` binary and make sure you have python3.13 installed.
