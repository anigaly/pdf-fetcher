...
[![PythonSupported](https://img.shields.io/badge/python-3.13-brightgreen.svg)](https://python3statement.org/#sections50-why)
...
Downloads clinical recommendation PDFs using IDs from an Excel file.
</div>
...
- [pdf_fetcher](pdf_fetcher) - source files of the project
